...
//  manifestReferrerMetadataPathSpec:  <root>/v2/repositories/<name>/_manifests/revisions/<algorithm>/<hex digest>/ref/<media type>
//  manifestReferrerMetadataLinkPathSpec:  <root>/v2/repositories/<name>/_manifests/revisions/<algorithm>/<hex digest>/ref/<media type>/<algorithm>/<hex digest>/link
//
//	Tags:
//
...
func pathFor(spec pathSpec) (string, error) {
	...
	case manifestReferrerMetadataPathSpec:
		...
		return path.Join(revisionPrefix, "ref", v.metadataMediaType), nil
